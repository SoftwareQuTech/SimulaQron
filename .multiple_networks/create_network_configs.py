...
def construct_settings(config_path, maxqubits=10, maxregs=1000, waittime=0.5, loglevel_back="info", backendhandler="simulaqron", topology_file="", noisy_qubits=True, T1=2, loglevel_front="warning"):
