...
class TestOptionalNoise(unittest.TestCase):
    ...
    def test_z0(self):
        with CQCConnection("Alice") as cqc:
            ...
            ans = cqc.test_preparation(
                prep_z0, exp_values=self.exp_values, iterations=self.iterations
            )
            sys.stdout.write("\r")
            self.assertTrue(ans)
    ...
    def test_z1(self):
        with CQCConnection("Alice") as cqc:
            ...
            ans = cqc.test_preparation(
                prep_z1, exp_values=self.exp_values, iterations=self.iterations
            )
            sys.stdout.write("\r")
            self.assertTrue(ans)
    ...
    def test_x0(self):
        with CQCConnection("Alice") as cqc:
            ...
            ans = cqc.test_preparation(
                prep_x0, exp_values=self.exp_values, iterations=self.iterations
            )
            sys.stdout.write("\r")
            self.assertTrue(ans)
    ...
    def test_x1(self):
        with CQCConnection("Alice") as cqc:
            sys.stdout.write("Testing noise on state (|0>-|1>)/sqrt(2)")
            ans = cqc.test_preparation(
                prep_x1, exp_values=self.exp_values, iterations=self.iterations
            )
            sys.stdout.write("\r")
            self.assertTrue(ans)
    ...
    def test_y0(self):
        with CQCConnection("Alice") as cqc:
            ...
            ans = cqc.test_preparation(
                prep_y0, exp_values=self.exp_values, iterations=self.iterations
            )
            sys.stdout.write("\r")
            self.assertTrue(ans)
    ...
    def test_y1(self):
        with CQCConnection("Alice") as cqc:
            sys.stdout.write("Testing noise on state (|0>-i|1>)/sqrt(2)")
            ans = cqc.test_preparation(
                prep_y1, exp_values=self.exp_values, iterations=self.iterations
            )
            sys.stdout.write("\r")
            self.assertTrue(ans)
