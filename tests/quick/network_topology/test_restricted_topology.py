...
@pytest.mark.skip(reason="Restricted topology is not yet supported in the new version of simulaqron")
class TestRestrictedTopology:
    @classmethod
    def setUpClass(cls):
        # default_settings ensures that the local configuration is NOT loaded
